...
public class ProducerConfig extends AbstractConfig {
    ...
    static {
        CONFIG = new ConfigDef().define(BOOTSTRAP_SERVERS_CONFIG, Type.LIST, Importance.HIGH, CommonClientConfigs.BOOSTRAP_SERVERS_DOC)
                                ...
                                .define(SecurityConfigs.SSL_CLIENT_REQUIRE_CERT_CONFIG, Type.BOOLEAN, SecurityConfigs.DEFAULT_SSL_CLIENT_REQUIRE_CERT, Importance.MEDIUM, SecurityConfigs.SSL_CLIENT_REQUIRE_CERT_DOC)
                                .define(SecurityConfigs.SSL_ENDPOINT_IDENTIFICATION_ALGORITHM_CONFIG, Type.STRING, SecurityConfigs.DEFAULT_SSL_ENDPOINT_IDENTIFICATION_ALGORITHM, Importance.MEDIUM, SecurityConfigs.SSL_ENDPOINT_IDENTIFICATION_ALGORITHM_DOC);
    }
